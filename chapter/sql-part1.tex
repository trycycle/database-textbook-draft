...
より複雑な読み出しやレコードの登録，更新などは第\ref{chap:sql-part2}で解説します．
...
もし\graybox{LIKE}演算子の条件を\graybox{\%チョコ\%}ではなく\graybox{\%チョコ}にした場合，「無添加 チョコチップパン」のように末尾が「チョコ」で終わらない商品名のレコードはマッチしなくなります．
