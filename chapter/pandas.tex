\chapter{pandasによるデータベース問い合わせ結果の処理}\label{chap:pandas}
...
\begin{itemize}
    \item \strong{正規化（Min-Max scaling）：} データが0から1の範囲に収まるように元データを変換．
    \begin{equation}
        x' = \frac{x - x_{\min}}{x_{\max} - x_{\min}}
        \label{eq:normalization}
    \end{equation}
    \item \strong{標準化（Z-score scaling）：} データの分布が平均を0，標準偏差を1になるように元データを変換．
    \begin{equation}
        x' = \frac{x - \mu}{\sigma}
