...
実体関連モデルを提唱したPeter Chenは自身が発表した論文\cite{Chen1997}において，以下のような対応付けの経験則を提案しています．
\begin{itemize}
\item 普通名詞: 実体型
\item 固有名詞: 実体
\item 他動詞: 関連型
...
\item 副詞: 関連の属性
\end{itemize}
以上の経験則は\strong{言語分析に基づく実体関連モデル抽出法}と呼ばれることがあります．
...
\item 出現頻度の高い名詞や，特定の動詞の主語・目的語となる名詞を「実体」候補とする
\item 実体同士を結びつける動詞を特定し，「関連」候補とする
\item 名詞を修飾する形容詞や自動詞から，実体の属性を抽出する
\item 動詞を修飾する副詞から，関連の属性を抽出する
\end{enumerate}

以上の経験則がうまく当てはまらないこともありますが，一定の目安にはなります．
