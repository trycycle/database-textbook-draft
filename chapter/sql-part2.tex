...
ダウンロードしたファイルは，\ref{chap:sql-part1}章で取り上げた小売店ショッピングサイトを管理するための関係データベースを拡張したものです．
...
差集合演算は演算の項の順序を入れ替えても結果が変わることがあります．
...
\begin{figure}[tb]
    ...
    \end{minted}
    \captionsetup{name=コード}
    \caption{USING句を使ってテーブル「注文」とテーブル「商品」を内部結合するSQL文}
...
テーブル``population''は，\ref{chap:sql-part1}章のクイズで用いたものです．
