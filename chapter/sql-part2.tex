...
コード\ref{code:sql-union}は，\graybox{関東人気商品}テーブルと\graybox{関西人気商品}テーブルの和集合を求めるSQL文である．
...
以下は，\graybox{関東人気商品}テーブルと\graybox{関西人気商品}テーブルのレコードのうち\graybox{価格}が1000円以上のレコードに限定して和集合を求めるSQL文です．
...
内部結合（INNER JOIN）は両方のテーブルにデータがあるものだけを残すため，例えば『まだ一度も注文をしたことがないユーザー』のデータが消えてしまいます．しかしデータサイエンスの世界では，『なぜこのユーザーは注文しなかったのか？』を分析するために，注文履歴がないユーザーのデータも残しておきたいことがよくあります．このように**『メインのデータ（左側のテーブル）は絶対に消さずに残しておきたい！』**というときに大活躍するのが，左外部結合（LEFT OUTER JOIN）なのです．
