...
\begin{titlepage}
    \vspace*{2cm}
    \noindent{\LARGE 関係データベース入門}\\
    \noindent{\large データにまつわる悲劇を防ぐデータベース設計とSQLの基礎}\\[2cm]
    \noindent{\large 山本 祐輔}
    \vfill
    %{\large 森北出版}\\
    %{\large \today}
...
\input{chapter/relational-data-model.tex}
\input{chapter/sql-part1.tex}
\input{chapter/anomaly.tex}
\input{chapter/er-model.tex}
\input{chapter/normalization.tex}
\input{chapter/sql-part2.tex}
\input{chapter/pandas.tex}
\input{chapter/design-and-analysis-example.tex}

\backmatter
\input{chapter/quiz-answer.tex}
\bibliography{reference}
\bibliographystyle{tipsj}

\newpage
\input{chapter/acknowledgment.tex}
